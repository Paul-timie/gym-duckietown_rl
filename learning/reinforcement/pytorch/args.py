...
def get_ddpg_args_train():
    ...
    parser.add_argument("--env_timesteps", default=1500, type=int)  # Max timesteps per episode
    parser.add_argument("--replay_buffer_max_size", default=5e4, type=int)  # Maximum number of steps to keep in the replay buffer
